---
title: "Rejecting Features Meta with Erratic"
date: "2022-10-18"
...
<Grid cols={2} gap={6}>
    <ImageEmbed
        ...
        mode="grid-item"
        cardTitle="Twist"
        cardContent="camera facing coordinate twisting creates a vortex effect"
    />
    <ImageEmbed
        ...
        mode="grid-item"
        cardTitle="Zoom"
        cardContent="adjusting the focal length narrows or widens view angle"
    />
    <ImageEmbed
        ...
        cardContent="repeating the algorithm in increasingly smaller scales"
    />
    <ImageEmbed
        ...
        mode="grid-item"
        cardTitle="Noise"
        cardContent="modifying the projected distance with perlin noise"
    />
    <ImageEmbed
        ...
        mode="grid-item"
        cardTitle="Warp"
        cardContent="adding to the projected distances along the z axis"
    />
    <ImageEmbed
        ...
        mode="grid-item"
        cardTitle="Distort"
        cardContent="adding to the projected distances along the x/y axis"
    />
</Grid>
