...
<Grid cols={3} gap={8}>
    ...
    <ImageEmbed
        ...
        cardContent="Each edition selects a major chord that contains a low root note, a 3 note chord in the mid-range, and an extra 5th & 7th in higher octaves. These 6 notes then use sample data within pixel bands as shown."
    />
    <ImageEmbed
...
In this episode I share a behind-the-scenes look at how Flux was made

<VideoEmbed id="K05P2oqXZKE" />
