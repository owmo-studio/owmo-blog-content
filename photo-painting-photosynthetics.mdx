---
title: "Photo Painting a Photosynthetic"
date: "2021-06-28"
...
<Grid cols={3} gap={6}>
    <ImageEmbed
        src="photosynthetic-0-risen.jpg"
        alt="Photosynthetic Risen"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
    />
    <ImageEmbed
        src="photosynthetic-1-rustic.jpg"
        alt="Photosynthetic Rustic"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
    />
    <ImageEmbed
        src="photosynthetic-2-heart.jpg"
        alt="Photosynthetic Heart"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
    />
    <ImageEmbed
        src="photosynthetic-3-royal.jpg"
        alt="Photosynthetic Royal"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
    />
    <ImageEmbed
        src="photosynthetic-4-ember.jpg"
        alt="Photosynthetic Ember"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
    />
    <ImageEmbed
        src="photosynthetic-5-glory.jpg"
        alt="Photosynthetic Glory"
        width={512}
        height={512}
        mode="grid-item"
        priority="true"
...
<ImageEmbed src="photosynthetic-2-resize.jpg" alt="Photosynthetic Step 2" width={384} height={384} mode="inset" />

## 3 - Fill the Canvas with Average Color

Sample the photo and determine the light or dark background average.

<ImageEmbed src="photosynthetic-3-fill.jpg" alt="Photosynthetic Step 3" width={384} height={384} mode="inset" />
...
<ImageEmbed src="photosynthetic-4-round.jpg" alt="Photosynthetic Step 4" width={512} height={512} mode="inset" />
...
<ImageEmbed src="photosynthetic-5-dark.jpg" alt="Photosynthetic Step 5" width={512} height={512} mode="inset" />
...
<ImageEmbed src="photosynthetic-6-blend.jpg" alt="Photosynthetic Step 6" width={1024} height={1024} mode="inset" />
